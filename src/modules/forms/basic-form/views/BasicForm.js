...
import { Form, Input, DatePicker, Select, Button, Card, InputNumber, Radio, Icon, Tooltip, message } from 'antd';
...
const title = '基础表单';
const content = '表单页用于向用户收集或验证信息，基础表单常见于数据项较少的表单场景';
export default wrapWithPageHeaderLayout(BasicForm, {title, content});
